...
Page({
  ...
  , getMoneyincomePush: function (page) {
    ...
    api.http('centre/zhaibiincome', 'GET',
      {
        userid: userid,
        page: pagePush
      }
  ...
  , saveMoneydisbursePop: function (page) {
    ...
    api.http('centre/zhaibidisburse', 'GET',
      {
        userid: userid,
        page: pagePop
      }
      , function (res) {
        ...
        if (res.code == 1) {
          var incomePopNew = incomePop.concat(res.disburse)
          if (res.disburse.length == 0) {
            self.setData({
              zhaibi: res.zhaibi,
          ...
          else if (res.disburse.length < 10) {
            self.setData({
              zhaibi: res.zhaibi,
              incomePop: incomePopNew,
              isShopLoaddingPop: false,
